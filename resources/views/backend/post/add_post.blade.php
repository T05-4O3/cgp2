                        ...
                        <form id="myForm" method="POST" action="{{ route('store.post') }}" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="post_title" class="form-control"  id="movieUrlInput">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-6">
                                    <div class="mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
									...
									<input name="post_tags" id="tags" value="SoYouKnow," />
                                </div>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="showImage" class="wd-80 rounded-circle" src="{{ url('upload/no_image.jpg') }}" alt="blog_image">
                            </div>
