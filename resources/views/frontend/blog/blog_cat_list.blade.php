...
@section('main')
    @section('title')
        {{ $breadcat->category_name }} | SoYouKnow
                ...
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-widget post-widget">
                        ...
                        <div class="post-inner">
                            ...
                            <div class="post">
                                <figure class="post-thumb"><a href="{{ url('blog/details/'.$item->post_slug) }}"><img src="{{ asset($post->post_image) }}" alt=""></a></figure>
                                <h5><a href="{{ url('blog/details/'.$item->post_slug) }}">{{ $post->post_title }}</a></h5>
