                    ...
                    <div class="card-body">
                        <div class="container-fluid d-flex justify-content-between">
                            ...
                            <div class="col-lg-3 pe-0">
                                ...
                                <h4 class="text-end fw-normal">¥50,000</h4>
                                ...
                                <div class="col-md-6 ms-auto">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <td class="text-bold-800 text-end"> ¥ 55,000.00</td>
                                            </tr>
                                            <tr>
                                            <td>Payment Made</td>
                        ...
                        <div class="container-fluid w-100">
                            <button type="submit" class="btn btn-primary float-end mt-4 ms-2"><i data-feather="send" class="me-3 icon-md"></i>SUBMIT</button>
                        </div>
                    </div>
                </form>
            </div>
