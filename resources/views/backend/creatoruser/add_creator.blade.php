    ...
    <div class="row profile-body">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Add Creator</h6>
                        <form id="myForm" method="POST" action="{{ route('store.creator') }}" class="forms-sample">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1" class="form-label">Creator Password</label>
