    ...
    <div class="row profile-body">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Edit Products Type</h6>
                        <form method="POST" action="{{ route('update.type') }}" class="forms-sample">
                            @csrf
                            <input type="hidden" name="id" value="{{ $types->id }}">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Products Type Name</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Products Type Icon</label>
